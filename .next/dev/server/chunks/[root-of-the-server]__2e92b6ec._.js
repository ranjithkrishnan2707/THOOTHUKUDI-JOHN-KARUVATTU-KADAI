...
"[project]/src/app/api/auth/otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const ALLOWED_ADMINS = [
            'johnkaruvattukadai@gmail.com',
            'odinfotech2024@gmail.com'
        ];
        let admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        if (!admin && ALLOWED_ADMINS.includes(email)) {
            // Auto-create admin if it matches our initial list
            admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                email,
                role: email === ALLOWED_ADMINS[0] ? 'SUPER_ADMIN' : 'ADMIN'
            });
        }
        if (!admin) {
        ...
        // Save OTP to DB
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$OTP$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            email
        }, {
            otp,
            expiresAt
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e92b6ec._.js.map